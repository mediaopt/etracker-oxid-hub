...
<script id="_etLoader" type="text/javascript" charset="UTF-8" data-secure-code="[{$mo_etracker__config.mo_etracker__securecode}]" data-respect-dnt="true" data-plugin-version="[{$mo_etracker__version}]" src="https://static.etracker.com/code/e.js"></script>
