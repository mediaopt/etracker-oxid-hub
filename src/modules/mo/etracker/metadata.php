...
$aModule = [
    ...
    'files'       => [
        'main' => 'mo/etracker/classes/mo_etracker__main.php',
        'install' => 'mo/etracker/classes/mo_etracker__install.php',
        'converter' => 'mo/etracker/classes/mo_etracker__converter.php',
        'event' => 'mo/etracker/classes/mo_etracker__event.php',
        'basketEvent' => 'mo/etracker/classes/events/mo_etracker__basketEvent.php',
        'basketEmptiedEvent' => 'mo/etracker/classes/events/mo_etracker__basketEmptiedEvent.php',
        'basketFilledEvent' => 'mo/etracker/classes/events/mo_etracker__basketFilledEvent.php',
        'noticeListEmptiedEvent' => 'mo/etracker/classes/events/mo_etracker__noticelistEmptiedEvent.php',
        'noticeListFilledEvent' => 'mo/etracker/classes/events/mo_etracker__noticelistFilledEvent.php',
        'orderCanceledEvent' => 'mo/etracker/classes/events/mo_etracker__orderCanceledEvent.php',
        'orderCompletedEvent' => 'mo/etracker/classes/events/mo_etracker__orderCompletedEvent.php',
        'orderConfirmedEvent' => 'mo/etracker/classes/events/mo_etracker__orderConfirmedEvent.php',
        'orderPartiallyCanceledEvent' => 'mo/etracker/classes/events/mo_etracker__orderPartiallyCanceledEvent.php',
        'productViewedEvent' => 'mo/etracker/classes/events/mo_etracker__productViewedEvent.php',
        'categoryController' => 'mo/etracker/controllers/admin/mo_etracker__category.php',
    ],
    'blocks'      => [
        [
